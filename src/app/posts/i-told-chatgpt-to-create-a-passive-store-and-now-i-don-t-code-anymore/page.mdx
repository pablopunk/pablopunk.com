...
<i className="text-xs text-neutral-8">by Pablo Varela at 2023/3/25</i>

<FeatureImage src="https://ik.imagekit.io/pablopunk/posts/i-told-chatgpt-to-create-a-passive-store-and-now-i-don-t-code-anymore.png?updatedAt=1698057162161" alt="I told ChatGPT to create a passive store and now I don't code anymore" />
...
![screenshot chat gpt pages index](https://i.imgur.com/SbMbWmX.png)
...
![make it SSG](https://i.imgur.com/LqqYZ2S.png)
...
![amazon-buddy docs](https://i.imgur.com/5erIfJB.png)

And it worked!

![amazon-buddy worked](https://i.imgur.com/vcq4oJc.png)
...
![autopartcove.com](https://i.imgur.com/sDDffeD.png)

...
<i className="text-xs text-neutral-8">by Pablo Varela at 2021/6/28</i>

<FeatureImage src="https://ik.imagekit.io/pablopunk/posts/how-to-replace-text-in-vim-only-inside-a-specific-search.jpg?updatedAt=1698057155846" alt="How to replace text in vim only inside a specific search" />

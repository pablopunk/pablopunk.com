...
<i className="text-xs text-neutral-8">by Pablo Varela at 2022/6/16</i>

<FeatureImage src="https://ik.imagekit.io/pablopunk/posts/developing-nextjs-cms-is-slow-here-s-the-fix.gif?updatedAt=1698057165875" alt="Developing NextJS + CMS is slow. Here's the fix" />
...
![](https://a.storyblok.com/f/113260/800x520/75f06711cd/fast-nextjs-cache.gif)

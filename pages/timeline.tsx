...
export default function Portfolio() {
  ...
  const items: TimelineItem[] = [
    ...
    },
    {
      ...
      cardDetailedText: _(`${timeBetween(new Date(2021, 1), new Date(2021, 7))}. 100% Remote`),
    ...
    },
    {
      ...
      cardDetailedText: _(`${timeBetween(new Date(2018, 0), new Date(2021, 1))}. 100% Remote`),
    ...
    },
    {
      ...
      cardDetailedText: _(`${timeBetween(new Date(2017, 6), new Date(2018, 2))}. 100% Remote`),
    ...
    },
    {
      ...
      cardDetailedText: _(`${timeBetween(new Date(2016, 1), new Date(2018, 0))}. 50% Remote / 50% Michigan`),
    ...
    },
    {
      ...
      cardDetailedText: _(`${timeBetween(new Date(2011, 8), new Date(2015, 5))}. Santiago de Compostela`),
      media: getImage('usc')
    },
    {
      title: _("Jul 1993"),
  ...
  return <div className='flex flex-col mt-4 gap-4 items-center'>
    ...
    <div className='min-w-[600px]'>
      ...
      }} borderLessCards mediaHeight={160} cardHeight={0} hideControls />
    </div>
    <style jsx>{`
      div :global(img) {
        height: 100%;

...
export const Card = ({
  ...
  return (
    <>
      <article ref={ref} className={classNames(className, "neon-card border-2 border-primary-8 md:max-w-[400px] p-5 bg-neutral-2 rounded-lg z-auto relative flex flex-col justify-between gap-2")}>
      ...
      <style jsx>{`
        ...
        article:before {
          ...
          right: 0;
          z-index: -1;
          box-shadow: ${boxShadow.x}px ${boxShadow.y}px 48px 16px var(--neon-shadow);
          border-radius: 8px;
        }
      `}</style>
    </>

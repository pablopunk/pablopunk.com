...
const ContrastIcon = ({ width = '10px', color = 'white' }) => (
  ...
  >
    <path
      d="M428.756,300.104c-0.664-3.81-2.334-7.047-4.996-9.713c-5.9-5.903-12.752-7.142-20.554-3.716
    ...
    return (
      <div>
        <button onClick={_ => toggleTheme(this.props.query.theme)}>
          <ContrastIcon width={width} color={buttonColor} />
          <span>
            Switch to{' '}
